...
def preprocess(data,folder,nparts=100, use_pid = True):
    ...
    print(f"jets shpae = {jets.shape}")
    print(f"particles shape = {particles.shape}")
    print(f"particles[0] shape = {particles[0].shape} ")
    print(f"particles[1] shape = {particles[1].shape} ")
    ...
    y0 = y[y==0]
    y1 = y[y==1]
    print(f"numer of 0 data before balance {y0.shape}")
    print(f"numer of 1 data before balance {y1.shape}")
    ...
    # understand data after balancing
    print(f"particles shape after balance {particles.shape}")
    print(f"y shape after balance {y.shape}")
    print(f"jets shape after balance {jets.shape}")
    y0 = y[y==0]
    y1 = y[y==1]
    print(f"numer of 0 data after balance {y0.shape}")
    print(f"numer of 1 data after balance {y1.shape}")
